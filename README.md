...
* **Запрещено читерство** - использование стороннего ПО, дающего серьёзное приемущество над другими игроками в бою и развитии. Небольшие QoL-фичи, такие как карта или зум, разрешены. Если не уверены, считается ли что-то читом, уточните у [стаффа](#общение-и-поддержка) сервера.
