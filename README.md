...
## Авторизация
Так как наш сервер не требует лицензии для входа, пользователю надо будет авторизовываться при каждом подключении.
* Команда для регистрации: `/trigger register set <пароль>`
* Команда для последующего входа: `/trigger register set <пароль>`

Пароль может состоять только из цифр. В целях безопасности, просьба не использовать ваши реальные пароли.
